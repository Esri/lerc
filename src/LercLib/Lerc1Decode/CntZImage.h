...
protected:
  ...
  bool readTiles(bool zPart, double maxZErrorInFile, int numTilesVert, int numTilesHori, float maxValInImg, const Byte* bArr, const Byte* bArr_end);

  bool readCntTile(const Byte** ppByte, const Byte* bArr_end, int i0, int i1, int j0, int j1);
  bool readZTile(const Byte** ppByte, const Byte* bArr_end, int i0, int i1, int j0, int j1, double maxZErrorInFile, float maxZInImg);

  static int numBytesFlt(float z);    // returns 1, 2, or 4
  static bool readFlt(const Byte** ppByte, const Byte* bArr_end, float& z, int numBytes);
