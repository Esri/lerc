...
namespace LercNS
{
    ...
    public static class LercCS
    {
        ...
        /// <param name="encodedLercBlobBuffer">Pre-allocated buffer for output. If you leave it empty/default,
        /// if will be allocated and filled automatically.</param>
                                         ...
                                         Span<byte> rasterDataBuffer = default)
        {
            ...
            if (lercBlobInfo.NMasks is not 0 && (pixelMasks.Length < pixelMaskSize))
